...
//       setInputText("");
//       // EDIT
//       setEditItemId(null); // Reset editItemId when adding a new todo
//     }
//   };
...
//     setEditItemId(id);
//     // Additional logic for handling the edit can be implemented here
//   };
...
//                   </button>
//                 ) : (
//                   /* Display input field or modal for editing */
//                   /* Here, you can display an input field or a modal for editing the todo item */
//                   /* For simplicity, I'm displaying a placeholder input field */
//                   <input
//                     type="text"
//                     value={todo.text} // You can bind this value to the editing text
//                     onChange={(e) => {
//                       // Handle changes to the editing text
//                     }}
//                     onBlur={() => {
//                       // Save changes and exit edit mode
//                       setEditItemId(null);
//                       // Additional logic to update the todo text goes here
//                     }}
          ...
          {todos.map((todo) => (
            <li key={todo.id} className="flex items-center mb-2">
              {editItemId !== todo.id ? (
                <span
                  className={
                    todo.completed ? "line-through text-[#CBD5E1]" : ""
                  }
                >
                  {todo.text}
                </span>
